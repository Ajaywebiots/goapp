                ...
                child: SafeArea(
                  ...
                  Stack(children: [
                    ...
                    Column(children: [
                      ...
                      DropdownButtonHideUnderline(
                              child: ButtonTheme(
                                  child: DropdownButton(
                                      value:
                                          languages.currentLanguage.toString(),
                      ...
                      ContainerWithTextLayout(title: "Title")
                        ...
                        SvgPicture.asset(eSvgAssets.details,
                                ...
                                colorFilter: ColorFilter.mode(
                                    !transDescriptionFocus.hasFocus
                                        ? transDescription.text.isNotEmpty
                                            ? appColor(context).darkText
                                            : appColor(context).lightText
                                        : appColor(context).darkText,
                                    BlendMode.srcIn))
                        ...
                        SvgPicture.asset(eSvgAssets.details,
                                ...
                                colorFilter: ColorFilter.mode(
                                    !transRemarksFocus.hasFocus
                                        ? transRemarksCtrl.text.isNotEmpty
                                            ? appColor(context).darkText
                                            : appColor(context).lightText
                                        : appColor(context).darkText,
                                    BlendMode.srcIn))
