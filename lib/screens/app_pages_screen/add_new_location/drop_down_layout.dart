        ...
        child: DropdownButtonHideUnderline(
                child: ButtonTheme(
                    child: DropdownButtonFormField(
                        selectedItemBuilder: (context) => list != null &&
                                list!.isNotEmpty
                        ...
                        style: isIcon == false ? appCss.dmDenseMedium12.textColor(appColor(context).darkText) : appCss.dmDenseMedium14.textColor(appColor(context).lightText),
                        icon: SvgPicture.asset(eSvgAssets.dropDown, colorFilter: ColorFilter.mode(isIcon == false ? appColor(context).darkText : appColor(context).lightText, BlendMode.srcIn)),
                        isDense: true,
                        isExpanded: true,
            ...
            .decorated(color: isIcon == false ? appColor(context).fieldCardBg : appColor(context).whiteBg, borderRadius: BorderRadius.circular(AppRadius.r8)),
      ),
    );
  }
}
