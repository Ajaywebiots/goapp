...
import '../services_details_screen/layouts/service_description.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<FavouriteListProvider>(builder: (context2, favCtrl, child) {
      return Consumer<ServicesDetailsProvider>(
        ...
        bool isArg = false;
        final attract = Provider.of<AttractionProvider>(context, listen: false);
                                    ...
                                    SingleChildScrollView(
                                        child: Column(
                                          ...
                                          ServiceImageLayout(
                                              isAttraction: true,
                                              image:
                                                  attractions?.image?.source),
                                          VSpace(Insets.i12),
                                          Text(attractions!.name.toString(),
                                                                      ...
                                                                      children: [
                                                                        SingleChildScrollView(
                                                                            child: Column(
                                                                              ...
                                                                              VSpace(Insets.i20),
                                                                              BottomSheetButtonCommon(textOne: appFonts.cancel, textTwo: appFonts.submit, applyTap: () => value.onSubmit(context), clearTap: () => value.onSubmit(context)).backgroundColor(appColor(context).whiteColor).alignment(Alignment.bottomCenter)
                                                                            ]))
