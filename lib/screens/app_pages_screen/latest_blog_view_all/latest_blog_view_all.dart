        ...
        child: Container(
          ...
          child: Column(
            children: value.blogList
                ...
                .entries
                .map((e) =>
                LatestBlogLayout(data: e.value,rPadding: 0,isView: true).width(MediaQuery.of(context).size.width))
                .toList(),
          ).paddingSymmetric(horizontal: Insets.i20).marginOnly(bottom: Insets.i15)
        )
      )
    );
  }
