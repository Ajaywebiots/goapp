...
class _SearchScreenState extends State<SearchScreen>
  ...
  void initState() {
    ...
    final categoryListPvr = Provider.of<CategoriesListProvider>(
      context,
      listen: false,
    );
              ...
              child: Scaffold(
                appBar: AppBarCommon(
                  ...
                  onTap: () {
                    ...
                    log(
                      "pro.isProfileBack==true::${pro.isProfileBack == true}",
                    );
                            ...
                            SingleChildScrollView(
                              ...
                              child:
                                  Row(
                                    ...
                                    top: Insets.i15,
                                    bottom: searchPvr.businessSearchList.isEmpty
                                        ? 0
                                        : 15,
                                  ),
                            ),
