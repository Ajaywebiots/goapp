      ...
      builder: (context1, serviceCtrl, child) {
        ...
        return StatefulWrapper(
          ...
          child: DirectionalityRtl(
            child: Scaffold(
              appBar: AppBarCommon(title: language(context, appFonts.review)),
              body: SafeArea(
                            ...
                            children: [
                              RatingBar(
                                ...
                                initialRating: double.parse(
                                  (review?.avarageRate ?? 0.0).toStringAsFixed(
                                    1,
                                  ),
                                ),
                                minRating: 1,
                              ...
                              Row(
                                children: [
                                  Text(
                                    language(context, appFonts.averageRate),
