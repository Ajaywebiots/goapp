...
import '../search_screen/layouts/third_filter.dart';
                                            ...
                                            child: Stack(children: [
                                              Column(
                                                    ...
                                                    Container(
                                                        ...
                                                        .paddingOnly(
                                                            top: Insets.i25,
                                                            bottom: (offerPvr.selectIndex == 0 ||
                                                                    offerPvr.selectIndex == 2)
                                                                ? Insets.i20
                                                                : 0,
                                                            left: Insets.i20,
                                                            right: Insets.i20),

                                                    if (offerPvr.selectIndex ==
                                                        0)
                                                      Text(
                                                              language(
                                                                  context,
                                                                      ...
                                                                      .builder(
                                                                          ...
                                                                          itemBuilder: (context,
                                                                            ...
                                                                            return ListTileLayout(
                                                                                data: offerPvr.categoryList[index],
                                                                                selectedCategory: offerPvr.selectedCategory,
                                                                  ...
                                                                  ? Expanded(
                                                                      child: ListView.builder(
                                                                          ...
                                                                          itemBuilder: (context, index) {
                                                                            return ListTileLayout(
                                                                                data: offerPvr.type[index],
                                                                                selectedCategory: offerPvr.selectedCategory,
                                                                                onTap: () => offerPvr.onCategoryChange(context, offerPvr.type[index].id));
                                                                          }))
