...
''';
                ...
                Row(
                  ...
                  children: List.generate(
                    appArray
                        ...
                        .length,
                    (index) {
                      final item = appArray.buttonItemsB(
  ...
  void showOpeningHoursBottomSheet(BuildContext context) {
    ...
    final List<Map<String, dynamic>> timeSlotList = generateTimeSlotList(
      workingHours,
    );
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            language(context, appFonts.openingHours),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...timeSlotList.asMap().entries.map(
                              (e) => AllTimeSlotLayout(
                                data: e.value,
                                index: e.key,
                                list: timeSlotList,
