            ...
            child: Column(
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                RatingBar(
                    ...
                    initialRating: double.parse(
                        (business?.rating?.starts ?? 0.0).toStringAsFixed(1)),
                    minRating: 1,
                    ignoreGestures: true,
                    itemSize: 13,
                    ...
                    ratingWidget: RatingWidget(
                        ...
                        empty: SvgPicture.asset('assets/svg/starWithout.svg'))),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Row(
                  ...
                  return Text("€",
                      style: appCss.dmDenseMedium12.textColor(index < priceRange
              ...
              (business?.offers.isEmpty ?? true)
                  ...
                  : Column(children: [
                      ...
                      ...business!.offers.asMap().entries.map((e) =>
                          CouponLayout(
                              data: e.value,
                              onTap: () => Provider.of<OfferProvider>(context,
                                      listen: false)
              ...
              HeadingRowCommon(
                  ...
                  horizontal: Insets.i20, top: Insets.i20, bottom: Insets.i12),
