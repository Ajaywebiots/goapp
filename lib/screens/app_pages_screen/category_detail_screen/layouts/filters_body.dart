    ...
    return Stack(alignment: Alignment.bottomCenter, children: [
      value.selectIndex == 0
          ? Column(children: [
              Row(children: [
                Expanded(
                    child: Text("${language(context, appFonts.providerList)} (${value.providerList.length})",
          ...
          : value.selectIndex == 1
              ? SecondFilter(
                  min: 0.0,
                  max: value.maxPrice,lowerVal: value.lowerVal,upperVal: value.upperVal,
                  selectIndex: value.ratingIndex,onDragging: (handlerIndex, lowerValue, upperValue) =>value.onSliderChange(handlerIndex, lowerValue, upperValue) ,
