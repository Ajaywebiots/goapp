...
class _LoginLayoutState extends State<LoginLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    final attractionId = args?["attractionId"]?.toString();
    final blogId = args?["blogId"]?.toString();
