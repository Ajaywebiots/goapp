...
class MyBusinessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<LanguageProvider, MyBusinessProvider>(
        builder: (context, languages, myBusinessPvr, child) {
      return Scaffold(
          appBar: AppBar(
              leadingWidth: 60,
            ...
            myBusinessPvr.businesses.isEmpty
                ...
                : Expanded(
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: myBusinessPvr.businesses.length,
                          ...
                          return SizedBox(
                            ...
                            Stack(alignment: Alignment.topRight, children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: myBusinessPvr.businesses[index]
                                                  .logo?.source !=
                                              null
                                          ? DecorationImage(
                                              image: NetworkImage(myBusinessPvr
                                                      .businesses[index]
                                                      .logo
                                                      ?.source ??
                                                  ""),
