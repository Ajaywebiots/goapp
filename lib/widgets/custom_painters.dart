...
class CouponPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style = PaintingStyle.fill;
    paint0Fill.color = const Color(0xff2362A8).withOpacity(0.1);
    canvas.drawPath(path_0, paint0Fill);
    ...
    paint2Fill.color = const Color(0xff2362A8).withOpacity(0.1);
...
class TimePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint1Fill = Paint()..style = PaintingStyle.fill;
    paint1Fill.color = const Color(0xff2362A8).withOpacity(0.1);
    canvas.drawPath(path_1, paint1Fill);
    ...
    Paint paint2Fill = Paint()..style = PaintingStyle.fill;
    paint2Fill.color = const Color(0xff2362A8).withOpacity(1.0);
    canvas.drawPath(path_2, paint2Fill);
  }
