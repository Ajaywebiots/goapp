import '../../../../config.dart';
import 'common_widget_layout.dart';
                ...
                child: DropdownButtonFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        disabledBorder: border ??
                            CommonWidgetLayout()
                                .noneDecoration(color: appColor(context).trans),
                    ...
                    icon: SvgPicture.asset(eSvgAssets.dropDown,
                        colorFilter: ColorFilter.mode(val == null ? appColor(context).lightText : appColor(context).darkText, BlendMode.srcIn)),
                    isDense: true,
                    isExpanded: true,
                    items: reviewLowHighList != null && reviewLowHighList!.isNotEmpty
