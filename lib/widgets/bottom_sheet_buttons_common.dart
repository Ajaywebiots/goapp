    ...
    return Row(children: [
      Expanded(
          child: ButtonCommon(
              ...
              onTap: clearTap,
              style:
                  appCss.dmDenseSemiBold16.textColor(appColor(context).primary),
              color: appColor(context).trans,
              borderColor: appColor(context).primary)),
      if (!isRateComplete) const HSpace(Sizes.s15),
      if (!isRateComplete)
        Expanded(
            child:
                ButtonCommon(title: textTwo!, onTap: applyTap, icon: iconTwo))
